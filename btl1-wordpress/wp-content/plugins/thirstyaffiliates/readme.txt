...
== Changelog ==
= 3.12.0 =
* Cleaned up plugin design and pro messaging
* Added setting to disable ThirstyPay
* Tweaked design of Reports page
* Change the order of menu items putting more used items close to the top
