...
use ThirstyAffiliates\Caseproof\GrowthTools\Helper\AddonHelper;

/**
 * Main plugin application.
 *
 * @see \ThirstyAffiliates\Caseproof\GrowthTools\instance() Instead of instantiating this class directly,
...
class App
{
    ...
    public function addMenu()
    {
        add_submenu_page(
            ...
            __('Growth Tools', 'thirstyaffiliates'),
            __('Growth Tools', 'thirstyaffiliates'),
            'activate_plugins',
    ...
    public function renderPage()
    {
        ...
        $labels      = [
            'notinstalled' => esc_html(__('Not Installed', 'thirstyaffiliates')),
            'installed'    => esc_html(__('Installed', 'thirstyaffiliates')),
            'activated'    => esc_html(__('Active', 'thirstyaffiliates')),
            'active'       => esc_html(__('Activate', 'thirstyaffiliates')),
            'deactive'     => esc_html(__('Deactivate', 'thirstyaffiliates')),
            'install'      => esc_html(__('Install', 'thirstyaffiliates')),
        ];
    ...
    {
        return '<h1 class="wp-heading-inline">' . esc_html__('Growth Tools', 'thirstyaffiliates') . '</h1>';
    }
}
