...
class Settings implements Model_Interface , Activatable_Interface , Initiable_Interface {
    ...
    */
    ...
    public function onboarding_page() {
        global $wpdb;
        $wpdb->query("INSERT INTO {$wpdb->options} (option_name, option_value) VALUES('ta_onboarded', '1') ON DUPLICATE KEY UPDATE option_value = VALUES(option_value);");
        ...
        if($step) {
          $steps = array(
            array(
              'title' => __('Activate License', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/license.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/license.php',
              'step' => 1,
            ),
            array(
              'title' => __('Enable Features', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/features.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/features.php',
              'step' => 2,
            ),
            array(
              'title' => __('Creating Your Link', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/thirstyaffiliates.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/thirstyaffiliates.php',
              'step' => 3,
            ),
            array(
              'title' => __('Categorize Your Link', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/category.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/category.php',
              'step' => 4,
            ),
            array(
              'title' => __('Finish Setup', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/finish.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/finish.php',
              'step' => 5,
            ),
            array(
              'title' => __('Complete', 'thirstyaffiliates'),
              'content' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/complete.php',
              'nav' => $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/nav/complete.php',
              'step' => 6,
            ),
          );

          require_once $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/wizard.php';
        }
        else {
          include_once $this->_constants->VIEWS_ROOT_PATH() . 'admin/onboarding/welcome.php';
        }
    ...
    public function render_settings_section_fields( $active_tab ) {
        ...
        do_action( 'ta_before_settings_section_fields', $active_tab );
    ...
    */
    ...
    public function ta_admin_header() {
        ...
        if ( empty( $dismissed ) && ! is_plugin_active( 'thirstyaffiliates-pro/thirstyaffiliates-pro.php' ) ) : ?>
            ...
            <script>
                jQuery(document).ready(function($) {
                    $('#close-ta-upgrade-header').on('click', function() {
